...
parser.add_argument('--data_dir', default='data/JDP/CS230_Visuomotor_Learning/parser/TeleOpVRSession_2018-02-05_15-44-11',
...
if __name__ == '__main__':
    ...
    path_to_labeling_dict = os.path.join('data/JDP/CS230_Visuomotor_Learning/parser/data', "img_name_to_khot_label_dict.p")
